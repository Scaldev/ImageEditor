...
class MySuite extends munit.FunSuite {
  ...
  val service_MT: Matrices[Int] = ImpMatrices[Int]
  val dsize: Int = 9
  ...
  test("matrices : null_matrix") {

    val obtained = service_MT.null_matrix(2, 0)

    val expected = (0 :: 0 :: Nil) :: (0 :: 0 :: Nil) :: Nil
  ...
  test("matrices : get_dimensions") {
    ...
    val m: Matrix[Int] =
      (1 :: 3 :: Nil) :: (2 :: 4 :: Nil) :: (0 :: 5 :: Nil) :: Nil
    val obtained = service_MT.get_dimensions(m)
  ...
  test("matrices : get_row") {

    val m: Matrix[Int] =
      (1 :: 3 :: Nil) :: (2 :: 4 :: Nil) :: (0 :: 5 :: Nil) :: Nil

    val obtained = service_MT.get_row(m, 1)
